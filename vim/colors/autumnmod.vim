...
hi Constant     term=underline  cterm=none      ctermfg=grey         ctermbg=bg      gui=none guifg=#bb6666  guibg=bg
...
" ----------tom
highlight MatchParen cterm=underline,bold ctermbg=none ctermfg=none gui=underline,bold guifg=none guibg=none
